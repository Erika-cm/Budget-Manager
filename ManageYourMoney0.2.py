...
class EnterBudgetAmounts(ctk.CTkFrame):
    ...
    def check_if_file_exists(self, event=None):
        ...
        if self.budget_name.get() != "":
            ...
            self.budget_file_path = user_files_path + "\\" + self.budget_name.get() + ".sqlite"
    ...
    def save_budget_to_database(self):
        ...
        if budget_confirmed == True:
            ...
            manage_new_budget_button = ctk.CTkButton(self.save_budget_success_window, text="Manage Your New Budget", fg_color="#00aaff", font=("calibri", 18), command=self.manage_new_budget)
